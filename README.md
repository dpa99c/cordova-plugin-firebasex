...
- *DO NOT* open issues related to the  [Ionic Typescript wrapper for this plugin](https://github.com/danielsogl/awesome-cordova-plugins/blob/master/src/%40awesome-cordova-plugins/plugins/firebase-x/index.ts)
